...
class RegistrationController extends AbstractController
{
    ...
    (Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, AppCustomAuthenticator $authenticator, EntityManagerInterface $entityManager, RouterInterface $router,): Response
    {
        $user = new User();
